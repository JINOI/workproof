...
function buildPrompt(languages: SupportedLanguageCode[]) {
  ...
  return [
    ...
    'Read the attached safety management guide document and generate training content for workers.',
    '',
    `Target languages: ${targetLanguages}.`,
    '',
    'Generation pipeline:',
    '1. Read the attached safety management guide/PDF first.',
    ...
    'Schema:',
    '{',
    '  "title": "short safety management guide title in Korean",',
    ...
    '- Prefer 4 to 8 cards when the document is ordinary length; use up to 10 only when the safety management guide has enough distinct safety topics.',
